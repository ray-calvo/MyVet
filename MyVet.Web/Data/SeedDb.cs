...
namespace MyVet.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Raymundo", "Calvo", "ray_calvo@hotmail.com", "443 173 1758", "Retorno Juan Antonio Riaño", "Admin");
            var customer = await CheckUserAsync("2020", "Raymundo", "Calvo", "raycalvo@hotmail.com", "443 173 1758", "Retorno Juan Antonio Riaño", "Customer");
